...
const useStore = create((set, get) => ({
	...
	setIsShowMediaModal: (isShow) => set(() => ({ isShowMediaModal: isShow })),
	urlMediaModal: '',
	setUrlMediaModal: (urlMedia) => set(() => ({ urlMediaModal: urlMedia })),
	stylePlayButtonMediaModal: {},
	setStylePlayButtonMediaModal: (style) => set(() => ({ stylePlayButtonMediaModal: style })),
}))
