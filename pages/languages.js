			...
			<div className="max-w-6xl min-h-full relative m-auto py-12">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap text-gray-100 px-24 py-4 justify-start">
                        ...
                        <div className="w-64 px-4 mb-12">
                            <div>French <span className="text-xs">(Needs Contributors)</span></div>
                            <div className="mt-2">
                        ...
                        <div className="w-64 px-4 mb-12">
                            <div>Korean <span className="text-xs">(Needs Contributors)</span></div>
                            <div className="mt-2">
                        ...
                        <div className="w-64 px-4 mb-12">
                            <div>Russian <span className="text-xs">(Needs Contributors)</span></div>
                            <div className="mt-2">
                        ...
                        <div className="w-64 px-4 mb-12">
                            <div>Vietnamese <span className="text-xs">(Needs Contributors)</span></div>
                            <div className="mt-2">
