...
const CardInfo = {
	...
	CollectDigitalCard: 'Коллекционируйте цифровое искусство, которым вы действительно можете обладать.',
	GoToLogin: 'Войти',
	...
	MakeSureNotOnSale: 'Пожалуйста, убедитесь в том, что ваша карточка не находится в продаже, чтоб принять ставку',
...
const publication = {
	...
	Title: 'Заголовок',
	SureToLeavepage: 'Вы уверены, что хотите покинуть страницу? Все несохранённые данные будут утеряны',
...
const common = {
	...
	FlaggedByPARASStealing: 'ПРЕДУПРЕЖДЕНИЕ: этот профиль был помечен PARAS из-за кражи искусства',
	UseOwnRisk:
...
const drops = {
	June9th: '9 Июня',
	OpenRegistrationFor: 'Открытая регистрация для пользователей для получения раннего доступа (белый список) для покупки NFT',
	June16th: '16 Июня',
	NFTDropsFor: 'Поступления NFT для подтверждённых аккаунтов',
	DropsWillStartOn:
		'Поступления начнутся с 16-го июня и закончатся 18-го июня в 00:00 (2 дня)',
	June19th: '19 Июня',
	NFTDropsPublic: 'Открытые публикации NFT (в случае наличия)',
	RemainingDropsWillStart:
		'Оставшиеся поступления начнут открыто продаваться 19-го июня в 00:01. Продажи прекратятся 24-го июня в 00:00 (5 дней)',
	June25th: '25 Июня',
	BurnRemainingNFTs: 'Сжечь все оставшиеся NFT',
	FillTheFormOf: 'Заполните форму Права на участие: https: /tripetto.app/run/2OGYWACAC6',
	FollowMTVRSOn: 'Следить за MTVRS на Twitter (https: /twitter.com/themtvrs)',
	RetweetLikeTag:
		'Делайте ретвиты, ставьте лайки, отмечайте ваших друзей в загреплённом твите про поступления NFT (https: /twitter.com/ParasHQ/status/1402264239927185422)',
	JoinMTVRSTelegram: 'Присоединяйтесь к группе Telegram MTVRS (https: /t.me/themtvrs)',
	JoinMTVRSDiscord: 'Присоединяйтесь к каналу Discord MTVRS (https: /discord.com/invite/wSNk3ktahF)',
	FollowParasOnTwitter: 'Следите за Paras на Twitter (https: /twitter.com/ParasHQ)',
	FollowParasOnInstagram: 'Следите за Paras в Instagram (https: /instagram.com/paras.hq/)',
	JoinParasTelegramGroup: 'Присоединяйтесь к группе Paras в Telegram (https: /t.me/parashq)',
	JoinParasDiscordServer: 'Присоединяйтесь к сервису Paras в Discord (https: /discord.com/invite/vWR2XBNupg',
	ParasXMTVRS: 'Paras X MTVRS - NFT Drops',
	NFTDrops: 'NFT Drops',
	MTVRSIsWorld:
		'MTVRS (www.mtvrs.app) мир миров и дом длля игр созданных на базе блокчейн для игроков, создателей и разработчиков! MTVRS разрабатывает платформу для проведения опытов и утилит вокруг блокчейн-активов.',
	MTVRFirstNFTDrop:
		'Это первое поступление NFT от MTVRS, “The Architect’s Devices” набор эксклюзивных коллекций, выкованных архитекторами метавселенной и дающих им возможность путешествовать по бесконечным мирам.',
	RegisterNow: 'Зарегестрироваться сейчас',
	FindOutMore: 'Узнать больше',
	Timeline: 'Таймлайн',
	HowToRegister: 'Как Зарегестрироваться',
	HowToRegisterSo:
		'Как Зарегестрироваться? Приступим! Для того чтоб получить подтверждение вашего аккаунта от Paras x MTVRS NFT Drops, пожалуйста, выполните следующие задания.',
	ReadDetails: 'Прочтите детали',
	ReadFullInformation: 'Вы можете прочесть полную информацию в публикации от Paras',
	Price: 'Цена',
	CardSupply: 'Спрос на Карточки',
	pcs: 'количество',
	CardAvailable: 'Доступно Карточек',
	SeeDetails: 'Просмотреть Детали',
}
const id = {
...
const license = {
	LicenseParas: 'Лицензия — Paras',
	NFTLicense: 'Лицензия NFT',
	Overview: 'Обзор',
