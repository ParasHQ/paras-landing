...
const common = {
	...
	FlaggedByPARASFake: 'ПРЕДУПРЕЖДЕНИЕ: Этот аккаунт использует чью-то личность',
	FlaggedByPARASHacked:
		'ПРЕДУПРЕЖДЕНИЕ: Аккаунт взломан. Пожалуйста, свяжитесь с первоначальным создателем',
	UseOwnRisk:
