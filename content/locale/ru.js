...
const CardInfo = {
	...
	SelectBuyTransaction: 'Выберите транзакцию покупки',
	...
	AboutToAcceptBid: 'Вы собираетесь принять предложение',
	AboutToRejectOffer: 'Вы собираетесь отклонить предложение от',
	From: 'от',
...
const tab = {
	...
	NoTokenDescription: 'Нет описания',
	NoTokenAttributes: 'Нет атрибутов',
	Burned: 'Сожжено',
}
const token = {
	SERIES: 'Серии',
