...
const market = {
  ...
  OnlyAllowWhitelisted: "Currently we only allow whitelisted Artist to create their digital art card on Paras.",
  ApplyUsingLink: "Apply now using the link below:",
  ApplyAsArtist: "申请成为艺术家",
  Status: "状态",
  Open: "打开",
  SubmitExistingCards: "提交现有卡片",
  CreateNewCard: "新增卡片",
  Curators: "馆长",
  PleaseEnterTokenID: "请输入正确的 Token ID",
  NotCreatorOfCard: "你不是这张卡片的创造者",
  ThankForsubmission: "谢谢你提交的建议。",
  SubmitSucceed: "提交卡片成功。",
  SubmitCardTo: "将您的卡提交给",
...
const CardInfo = {
  ...
  Upload: "上传",
  PutOnMarketplace: "上市",
  UploadingImageMeta: "上传图像和元数据",
  CreateNewCollection: "创建新收藏品",
  Confirmation: "确认",
  ConfirmTransactionOnNear: "在Near钱包上确认您的交易",
  SmallTransactionFee: "小额交易费为",
  NumberOfCopies: "份数",
  Name: "名称",
  CardCreation: "卡片制作",
  WillSubmitCardTo: "您将把卡片提交给",
  ConfirmCardCreation: "确认卡片创建",
  NoCards: "暂无卡片",
  StartFrom: "起于",
  SALE: "出售",
  SeeDetails: "查看详情",
  ...
  PutOnSaleFor: "出售",
  RemoveFromSale: "停止销售",
  'Bought{quantity}PcsFrom': "从中购买 {quantity}片",
  'CreateSupply{quantity}Pcs': "以{quantity}件的供应量创建",
  'Burned{quantity}Pcs': "销毁 {quantity}片",
  PlacedOfferFor: "出价",
  'Transfer{quantity}PcsTo': "发送 {quantity}片给",
  Owns: "拥有",
  OnSale: "打折",
  Update: "更新",
  Buy: "购买",
  ...
  Facebook: "Facebook",
  CardListing: "卡片列表",
  SetQuantityTo: "将销售数量设置为",
  OnlyWantRemoveFrom: `if you only want to remove
...
const publication = {
  ...
  Publication: "出版",
  EnhancingVisualsStories: "通过故事增强视觉效果",
  All: "全部",
  Editorial: "编辑",
  Community: "社区",
...
const profile = {
  ...
  MaximumSize3MB: "最大文件大小 3MB",
  Image: "图片",
  Card: "卡片",
  Video: "视频",
  EmbeddVideo: "嵌入视频",
  EnterLinkYoutube: "请输入youtube视频的链接",
  AddVideo: "添加视频"

}
const modal = {
  CollectNFTTrulyOwn: "收集你能真正拥有的NFT.",
  WillBeRedirectedTo: "您将被重定向到NEAR钱包",
  GoToLogin: "去登录",
  BurnAsset: "销毁资产",
  AreAboutToBurn: "您将销毁",
  ...
  Total: "总计",
  GetForFree: "免费获得",
  AreAboutToReduce: "您将减少",
  CannotReduceMore: "不能减少超过当前份数",
  AvailableCopies: "可用份数",
  DecreaseCopies: "减少份数",
  Reduce: "减少",
  DecreaseCopiesBy: "减少份数",
  StorageFee: "存储费",
  ConfirmMint: "确认铸造",
  AreAboutToMint: "您将铸造",
  MintToMyself: "Mint to myself",
  NoTokensOwned: "没有 Tokens",
  Edition: "版次",
  SeriesListing: "系列列表",
  NewPrice: "新价格",
  CurrentPrice: "当前价格",
...
const login = {
  LoginParas: "登录 — Paras",
  CreateAndCollect: "创建和收集",
  StartJourneyCards: "通过区块链上的数字艺术卡开始您的旅程",
  LoginWithNEAR:  "使用NEAR登录",
  CreateFreeNEARAccount: "使用Metamask创建免费NEAR帐户"
}
const activity = {
  Detail: "详情",
  Supply: "供应",
...
const categorySubmission = {
  DontHavePermission: "你没有权限",
  CategorySubmission: "类别提交",
  NoCardSubmission: "找不到提交的卡片",
...
const verify = {
  HomeTitle: "Paras — Digital Art Cards Market",
  EmailIsVerified: "您的邮箱验证通过",
  VerificationError: "验证错误",
  LinkVerificationExpired: "您的链接验证已过期",
  BackToMarket: "返回到市场"
}
const faq = {
...
const newCollection = {
  ...
  CreateCollectionSuccess: "创建收藏品成功",
  Logo: "Logo",
  CreatingLoading: "创建中..."
