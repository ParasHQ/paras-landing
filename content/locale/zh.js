...
const CardInfo = {
  ...
  this card from listing`,
	...
	'Sale quantity': '销售数量',
	'Edit Image': '编辑图片',
	'You will be burning': '您将会被销毁',
	'You are not allowed to list this card at the moment': '目前不允许您上架这张卡',
	'You are not allowed to buy this card at the moment. Only whitelisted account can buy this card':
		'您现在不允许买这张卡。只有白名单上的帐户才能购买此卡',
	'You are about to accept bid for': '您将要接受投标',
	from: '从',
	...
	'Please make sure that your card is not on sale to accept the bid':
		'请确保您的卡不在出售中，以接受出价',
	'You successfully accepted the bid from': '您成功地接受了来自的投标',
	'Your bid has been deleted': '您的出价已被删除',
	'Are you sure to delete your bids?': '您确定要删除您的出价吗？',
	Bid: '投标',
...
const tab = {
	...
	burned: '销毁',
	'transferred to': '发送到',
	'Series created by': '系列创建人是',
	'Creator put the series to not for sale': '创作者将该系列作品下架',
	'Creator put the series on sale for': '创作者将该系列作品出售以',
	'Creator put the series to non-mintable': '创作者将该系列作品设置为不可铸造',
	'Creator decrease the series copies to': '创建者将系列作品份数减少到',
	Owner: '主人',
	Copies: '份',
	'No owners, become the first one!': '暂无主人，成为第一个！',
	Burned: '销毁',
}
const token = {
	SERIES: '系列',
...
const activity = {
	...
	'Top Buyers': 'Top 买家',
	'in 7 days': '7日内',
	'see top sellers': '查看 top 卖家',
	'Activity — Paras': '活动 — Paras',
	'Top Users': 'Top 用户',
	'No Transactions': '暂无交易',
	'put on sale for': '出售',
	'removed from sale by': '取消出售被',
	'created by': '创建人',
	'with supply of {quantity}pcs': '供应{quantity}件',
	'burned {quantity}pcs by': '销毁{quantity}件被',
	'placed offer': '出价',
}
