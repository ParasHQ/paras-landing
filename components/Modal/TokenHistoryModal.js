...
import { IconShareActivity, IconX } from 'components/Icons'
import Modal from 'components/Modal'
const FETCH_TOKENS_LIMIT = 12

const TokenHistoryModal = ({ localToken, show, onClose }) => {
	...
	return (
		<Modal isShow={show} closeOnBgClick={true} closeOnEscape={true} close={onClose}>
			<div className="text-white h-1/2 max-w-lg py-4 w-full bg-cyan-blue-1 m-auto rounded-md relative overflow-hidden pb-14">
				...
				<div className="px-4">
					<p className="text-2xl font-semibold text-gray-100">History</p>
				</div>
...
const Activity = ({ activity }) => {
	...
	return (
		<div className="bg-cyan-blue-2 mt-3 p-3 rounded-md shadow-md flex items-center justify-between relative">
		...
		<>
			{SHOW_TX_HASH_LINK && activity.transaction_hash && (
				<a
					...
					target={`_blank`}
				>
					<div className="w-8 h-8 rounded-full transition-all duration-200 hover:bg-cyan-blue-1 flex items-center justify-center">
