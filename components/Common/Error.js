			...
			<div className="h-full w-full max-w-6xl m-auto relative">
				<div className="h-full w-full flex items-center justify-center">
					<div className="text-center">
						...
						<div className="mt-8">
							<div className="px-4">
								<h1 className="text-gray-100 mt-4 text-6xl">{statusCode || 'OOPS!'}</h1>
								<h4 className="text-lg text-gray-300">
									{errorText[statusCode] || 'Something went wrong'}
								</h4>
								<div className="mt-16">
									<Link href="/market">
										<a className="flex items-center text-gray-100 justify-center">
											<svg
												className="pr-2"
												width="24"
												height="24"
