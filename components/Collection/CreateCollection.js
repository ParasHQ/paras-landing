				...
				toast.show({
					text: (
						<div className="font-semibold text-center text-sm">
							{localeLn('Create_Collection_Success')}
						</div>
					),
					type: 'success',
					duration: 2500,
	...
	return (
		<>
			...
			<div className="relative max-w-3xl m-auto p-4">
				<div className="text-white font-bold text-4xl">{localeLn('Nav_Create_Collection')}</div>
				...
				<Button
					...
					onClick={_submit}
				>
					{isSubmitting ? localeLn('Creating_Loading') : localeLn('Create')}
				</Button>
			</div>
		</>
	)
